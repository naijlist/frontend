  ...
  >
    <div class="grid h-full max-w-lg grid-cols-4 mx-auto">
      <button
        ...
        type="button"
        class="inline-flex flex-col items-center justify-center px-5 hover:bg-primary dark:hover:bg-gray-800 group"
      >
        <svg
          class="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-white dark:group-hover:text-blue-500"
          aria-hidden="true"
