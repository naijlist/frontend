    ...
    <div class="w-full flex justify-center items-center">
      <div>
        <auth-card>
          ...
          <p class="text-textColor text-sm mt-4">We have been waiting for you</p>
          <button
            class="flex gap-10 items-center px-4 py-2 border border-textColor w-[320px] rounded-md text-sm mt-[40px]"
          >
            <span>
              <svg
                width="17"
          ...
          <div class="flex justify-center items-center gap-2 w-full mt-8 mb-5">
          ...
          <div class="mt-4">
            <p class="text-sm">
              ...
              <router-link to="/login" class="text-pc2"> Sign In </router-link>
            </p>
          </div>
        </auth-card>
      </div>
