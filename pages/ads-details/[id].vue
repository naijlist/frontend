<template>
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3  gap-5 px-4 lg:px-16 pt-24 mb-7">
        <div class="col-span-2 rounded-md">
            <img src="/imgs/lenovot450.jpg"  alt="ads-img" class="w-full rounded-md mb-5">
        <div class=" col-span-2 rounded-md bg-white px-5 py-5"> 
            ...
            <div class="md:px-3 py-5 flex gap-5 sm:gap-10">
                ...
                <span class="text-xs" >posted 1 hr ago</span>
                </p>
                <p class="flex gap-2 justify-center items-center text-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-700" width="24" height="24" style="fuser-select: auto;">
                    <path d="M12 14c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4 1.794 4 4 4zm0-6c1.103 0 2 .897 2 2s-.897 2-2 2-2-.897-2-2 .897-2 2-2z" style="user-select: auto;"></path><path d="M11.42 21.814a.998.998 0 0 0 1.16 0C12.884 21.599 20.029 16.44 20 10c0-4.411-3.589-8-8-8S4 5.589 4 9.995c-.029 6.445 7.116 11.604 7.42 11.819zM12 4c3.309 0 6 2.691 6 6.005.021 4.438-4.388 8.423-6 9.73-1.611-1.308-6.021-5.294-6-9.735 0-3.309 2.691-6 6-6z" style="user-select: auto;"></path>
                    </svg>
                    <span class="text-xs">Gwarinpa, Abuja</span>

                </p>
                <p class="flex gap-2 justify-center items-center text-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="fill: rgb(0, 0, 0); user-select: auto;">
                        <path d="M12 9a3.02 3.02 0 0 0-3 3c0 1.642 1.358 3 3 3 1.641 0 3-1.358 3-3 0-1.641-1.359-3-3-3z" style="user-select: auto;"></path><path d="M12 5c-7.633 0-9.927 6.617-9.948 6.684L1.946 12l.105.316C2.073 12.383 4.367 19 12 19s9.927-6.617 9.948-6.684l.106-.316-.105-.316C21.927 11.617 19.633 5 12 5zm0 12c-5.351 0-7.424-3.846-7.926-5C4.578 10.842 6.652 7 12 7c5.351 0 7.424 3.846 7.926 5-.504 1.158-2.578 5-7.926 5z" style="user-select: auto;"></path>
                    </svg>
                    <span class="text-xs sm:text-sm">100 views</span>
                </p>
            </div>
            <hr/>
            ...
            <hr>
            <div class="py-5 px-5">
                <h3 class="text-2xl mb-5">Description</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae dolorum harum in veritatis ipsam, laborum nemo commodi reprehenderit voluptatibus quidem? Pariatur enim aut dignissimos vitae ratione quo qui eum nulla!</p>
            </div>
        </div>
            ...
            <div class=" bg-white  rounded-md px-5 py-5 mb-5">
                <div class="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p class="px-2 text-sm">Reply ASAP</p>
                    </div>
                </div>
                <button 
                @click="showSellerPhone = true"
                class="flex 
                justify-center 
                bg-primary 
                ...
                text-white">
                    ...
                    &nbsp; {{showSellerPhone ? '08060508036' : 'Show phone'}}
                </button>
            </div>
            <div class=" bg-white  rounded-md px-5 py-5 mb-5">
...
export default {
    setup () {
        const showSellerPhone = ref(false)
        return {
            showSellerPhone
        }
    }
